...
$("#map").gmap3({
    marker:{     
	address:"R Finlândia 567 - Rincão - Novo Hamburgo - RS", 
	options:{ icon: "img/market.png"}},
    map:{
    options:{
	styles: [ {
...
(function ($, window, document, undefined) {
    ...
    $('.cbp-l-loadMore-button-link').on('click', function(e) {
        ...
        // set loading status
        oMsg = me.text();
        //me.text('CARREGANDO, POR FAVOR AGUARDE...');
        ...
        .done( function (result) {
            ...
            items = $(result).filter( function () {
                return $(this).is('div' + '.cbp-loadMore-block1');
            });
            ...
            gridContainer.cubeportfolio('appendItems', items.html(),
                ...
                //      me.text('NÃO AH MAIS PRODUTOS NO CATÁLOGO');
