...
$EMP_result = EMP_selectAll("managerbr", $EMP_db);
...
<?php
    if (isset($_POST['alterar'])) {
        try{
        $atualiza = $EMP_db->prepare('UPDATE managerbr SET slide1 = :slide1, slide2 = :slide2, slide3 = :slide3, slideTitle1 = :slideTitle1, slideTitle2 = :slideTitle2, slideTitle3 = :slideTitle3,
...
<head>
    ...
    <title>Painel Administrativo - Gerenciador de conteúdo BR</title>
...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gerenciador de conteúdo - BR</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                <div class="form-group">
                                            ...
                                            <input class="form-control" name="donationSubtitle" id="donationSubtitle" value="<?php echo $EMP_lineManager['donationSubtitle']?>" maxlength="80">
