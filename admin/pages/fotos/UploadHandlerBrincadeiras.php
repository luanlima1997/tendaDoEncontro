...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/categorias/Brincadeiras/',
            'upload_url' => $this->get_full_url().'/categorias/Brincadeiras/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
