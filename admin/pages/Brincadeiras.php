...
<head>
    ...
    <title>Painel Administrativo - Álbum de fotos - Brincadeiras</title>
...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Álbum de fotos - Brincadeiras</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-camera fa-fw"></i> Gerenciamento de fotos
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                <ul>
                <li>O tamanho máximo da foto para upload é de <strong>500KB</strong>.</li>
                <li>Somente fotos <strong>JPG e PNG</strong> seram aceitas.</li>
                <li>Você pode <strong>Arrastar e Soltar</strong> as fotos do seu desktop nesta página.</li>
                <li>O nome da foto é o <strong>nome</strong> do arquivo sem a sua extensão, exemplo: <strong>imagem</strong>.jpg.</li>
            </ul>
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <tr class="template-download fade">
        <td>
            <span class="preview">
                {% if (file.icon_brincadeirasUrl) { %}
                    <a href="{%=file.url%}" title="{%=file.name%}" download="{%=file.name%}" data-gallery><img src="{%=file.icon_brincadeirasUrl%}"></a>
                {% } %}
            </span>
        </td>
        <td>
            <p class="name">
                {% if (file.url) { %}
                    <a href="{%=file.url%}" title="{%=file.name%}" download="{%=file.name%}" {%=file.icon_brincadeirasUrl?'data-gallery':''%}>{%=file.name%}</a>
                {% } else { %}
                    <span>{%=file.name%}</span>
                {% } %}
            </p>
...
<script src="js/main_brincadeiras.js"></script>
<!-- Custom Theme JavaScript -->
<script src="../dist/js/sb-admin-2.js"></script>
