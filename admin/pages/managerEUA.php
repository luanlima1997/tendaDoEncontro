...
$EMP_result = EMP_selectAll("managereua", $EMP_db);
...
<head>
    ...
    <title>Painel Administrativo - Gerenciador de conteúdo EUA</title>
...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gerenciador de conteúdo - EUA</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
